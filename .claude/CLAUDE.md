...
- 定期执行一致性检查
- 技能包：`.claude/skills/planner-skill/SKILL.md` + `archive-maintenance.md` + `templates/`
...
3. 派planner构建大纲
   - 读取 `.claude/skills/planner-skill/SKILL.md` + `templates/outline-template.md`
   - 产出完整大纲，主Agent呈现给人类确认
4. 派planner设计人物
   - 读取 `.claude/skills/planner-skill/templates/character-template.md`
...
参考：`.claude/skills/shared/hook-techniques.md`
...
参考：`.claude/skills/reviewer-skill/review-checklist.md`, `.claude/skills/reviewer-skill/quality-standards.md`, `.claude/skills/shared/deai-rules.md`, `.claude/skills/shared/hook-techniques.md`
